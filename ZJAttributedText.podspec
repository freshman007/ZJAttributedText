Pod::Spec.new do |s|
  ...
  s.public_header_files = 'ZJAttributedText/Classes/ZJAttributedText.h, ZJAttributedText/Classes/Core/NSString+AttributedText.h, ZJAttributedText/Classes/Model/ZJTextAttributes.h, ZJAttributedText/Model/ZJTextElement.h'
  s.source_files = 'ZJAttributedText/Classes/**/*.{h,m}'
